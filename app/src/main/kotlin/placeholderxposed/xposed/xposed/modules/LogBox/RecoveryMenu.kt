package placeholderxposed.xposed.modules.LogBox
...
object RecoveryMenu {
    ...
    fun showRecoveryMenu(context: Context) {
        ...
        try {
            ...
            container.addView(LogBoxComponents.createTitle(context, colors, "placeholderxposed Recovery", center = true))
    ...
    private fun handleMenuSelection(context: Context, index: Int) {
        when (index) {
            ...
            3 -> placeholderxposed.xposed.Utils.Companion.reloadApp()
            4 -> showConfirmAction(
                context,
                "Clear Cache & Reset",
